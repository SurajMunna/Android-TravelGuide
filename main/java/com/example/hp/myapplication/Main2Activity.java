...
public class Main2Activity extends AppCompatActivity {
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(user_email,user_password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(Main2Activity.this, "Successfully Registered, Upload complete!", Toast.LENGTH_SHORT).show();
                                finish();
                                startActivity(new Intent(Main2Activity.this, MainActivity.class));
                            }
                            else{
                                Toast.makeText(Main2Activity.this, "Failed, Upload Incomplete!", Toast.LENGTH_SHORT).show();
                            }
    ...
    private void setupUIViews(){
        ...
        userPhoneNo = (EditText) findViewById(R.id.etPhoneNo);
